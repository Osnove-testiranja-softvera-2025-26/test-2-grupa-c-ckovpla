...
namespace GymApp.Services
{
    ...
    namespace GymApp
    {
        public class GymService
        {
            ...
            public GymService(IPaymentService paymentService,
                              ITrainingService trainingService,
                              ITrainerPerformanceService trainerPerformanceService)
            {
            ...
            public GymService(FakePaymentService fakePaymentService, FakeTrainerPerformanceService fakeTrainerPerformanceService, FakeTrainingService fakeTrainingService)
            {
                FakePaymentService = fakePaymentService;
                FakeTrainerPerformanceService = fakeTrainerPerformanceService;
                FakeTrainingService = fakeTrainingService;
            }

            public IPaymentService PaymentService { get; }
            public ITrainingService TrainingService { get; }
            public ITrainerPerformanceService PerformanceService { get; }
            public FakePaymentService FakePaymentService { get; }
            public FakeTrainerPerformanceService FakeTrainerPerformanceService { get; }
            public FakeTrainingService FakeTrainingService { get; }

            public void DoStaffBonusPaymentCalculation(Trainer trainer)
            {

                List<Trainer> trainings = _trainingService.GetTrainingsInTheLastMonth(trainer.Id);
